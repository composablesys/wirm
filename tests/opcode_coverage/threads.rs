...
const A0: MemArg = MemArg { align: 0, max_align: 0, offset: 0, memory: 0 };
const A1: MemArg = MemArg { align: 1, max_align: 1, offset: 0, memory: 0 };
const A2: MemArg = MemArg { align: 2, max_align: 2, offset: 0, memory: 0 };
const A3: MemArg = MemArg { align: 3, max_align: 3, offset: 0, memory: 0 };
