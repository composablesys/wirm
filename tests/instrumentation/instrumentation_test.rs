    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![(
                ...
                (InstrumentationMode::BlockAlt, vec![Operator::I32Const { value: 12 }, Operator::Drop]),
            )]);
        },
    );
}
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (
                    ...
                    (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 12 }, Operator::Drop]),
                ),
                (
                    SupportedOperators::Else,
                    (InstrumentationMode::BlockAlt, vec![]),
    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (
                    SupportedOperators::If,
                    (InstrumentationMode::BlockExit, vec![Operator::I32Const { value: 12 }, Operator::Drop]),
                ),
                (
                    SupportedOperators::Else,
                    (InstrumentationMode::BlockAlt, vec![]),
    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (
                    SupportedOperators::Block,
                    (InstrumentationMode::BlockEntry, vec![Operator::I32Const { value: 12 }, Operator::Drop]),
                ),
                (
                    SupportedOperators::Loop,
                    (InstrumentationMode::BlockEntry, vec![Operator::I32Const { value: 34 }, Operator::Drop]),
                ),
            ]);
        },
    );
    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                ...
                (
                    SupportedOperators::If,
                    (InstrumentationMode::BlockEntry, vec![Operator::I32Const { value: 56 }, Operator::Drop]),
                ),
            ]);
        },
    );
    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                ...
                (
                    SupportedOperators::Else,
                    (InstrumentationMode::BlockEntry, vec![Operator::I32Const { value: 78 }, Operator::Drop]),
                ),
            ]);
        },
    );
    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                ...
                (
                    SupportedOperators::Loop,
                    (InstrumentationMode::BlockExit, vec![Operator::I32Const { value: 34 }, Operator::Drop]),
                ),
            ]);
        },
    );
    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                ...
                (
                    SupportedOperators::If,
                    (InstrumentationMode::BlockExit, vec![Operator::I32Const { value: 56 }, Operator::Drop]),
                ),
            ]);
        },
    );
    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                ...
                (
                    SupportedOperators::Else,
                    (InstrumentationMode::BlockExit, vec![Operator::I32Const { value: 78 }, Operator::Drop]),
                ),
            ]);
        },
    );
...
fn test_fn_entry_one_func() {
    run_module_instr_test(
        ...
        |mod_it| inject_function_entry(mod_it, vec![Operator::I32Const { value: 1 }, Operator::Drop]),
    );
}
...
fn test_fn_exit_one_func() {
    run_module_instr_test(
        ...
        |mod_it| inject_function_exit(mod_it, vec![Operator::I32Const { value: 1 }, Operator::Drop]),
    );
}
...
fn test_semantic_after_medium_1br() {
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (SupportedOperators::Block, (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 12 }, Operator::Drop])),
                (SupportedOperators::Br,    (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 23 }, Operator::Drop])),
            ]);
        },
    );
}
...
fn test_semantic_after_medium_1br_if() {
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (SupportedOperators::Block, (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 12 }, Operator::Drop])),
                (SupportedOperators::BrIf,  (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 23 }, Operator::Drop])),
            ]);
        },
    );
}
...
fn test_semantic_after_medium_1br_table() {
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (SupportedOperators::Block,   (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 12 }, Operator::Drop])),
                (SupportedOperators::BrTable, (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 23 }, Operator::Drop])),
            ]);
        },
    );
}
...
fn test_semantic_after_medium_blocks() {
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (SupportedOperators::Block,   (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 12 }, Operator::Drop])),
                (SupportedOperators::BrTable, (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 34 }, Operator::Drop])),
            ]);
        },
    );
}
...
fn test_semantic_after_medium_ifelse() {
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (SupportedOperators::Block,   (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 12 }, Operator::Drop])),
                (SupportedOperators::If,      (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 23 }, Operator::Drop])),
                (SupportedOperators::Else,    (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 34 }, Operator::Drop])),
                (SupportedOperators::Br,      (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 45 }, Operator::Drop])),
                (SupportedOperators::BrTable, (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 56 }, Operator::Drop])),
            ]);
        },
    );
}
    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (SupportedOperators::Block,   (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 12 }, Operator::Drop])),
                (SupportedOperators::If,      (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 23 }, Operator::Drop])),
                (SupportedOperators::Br,      (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 34 }, Operator::Drop])),
                (SupportedOperators::BrTable, (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 45 }, Operator::Drop])),
            ]);
        },
    );
}
...
fn test_semantic_after_medium_multiple() {
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (SupportedOperators::BrIf,    (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 1234 }, Operator::Drop])),
                (SupportedOperators::BrTable, (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 5678 }, Operator::Drop])),
            ]);
        },
    );
}
    ...
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![(
                ...
                (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 1234 }, Operator::Drop]),
            )]);
        },
    );
}
...
fn test_semantic_after_simple_1if() {
    run_module_instr_test(
        ...
        |mod_it| {
            run_block_injection(mod_it, &vec![
                (SupportedOperators::If, (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 12 }, Operator::Drop])),
                (SupportedOperators::Br, (InstrumentationMode::SemanticAfter, vec![Operator::I32Const { value: 34 }, Operator::Drop])),
            ]);
        },
    );
